...
public class BookingServiceImpl implements BookingService {
    ...
    // Create new booking
    @Override
    public ResponseEntity<?> createBooking(String Id, BookingDto bookingDto, String show_id) throws RuntimeException{
        try {
    ...
    // Get bookings
    @Override
    public List<BookingResponse> getBookingsByUser(Map<String,String> allParams) throws RuntimeException{
        try {
            if(allParams.size()!=1)
                throw new BadReqException("Invalid Input");
